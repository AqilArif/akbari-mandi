...
const SpfCategory = () => {
  ...
  const getProductData = async () => {
    const res = await axios.get(`/api/web/category-product/${id}`);
    console.log(res.data.products);
    setSingleCatProduct(res.data.products);
  };
  return  (
          ...
          <div className="all-product-grid">
            <div className="container">
              ...
              <div className="product-list-view">
                <div className="row">
                  {!singleCatProduct ? <h1>Loading....</h1>:singleCatProduct.map((product) => {
                    return (
